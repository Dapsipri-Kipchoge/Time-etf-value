...
<tr><td class="l">fPER</td><td>≤ 30</td><td class="l">시가총액 ÷ 당해E <b>지배주주순이익</b> (컨센 없으면 당기순이익 대체, 비고 표시)</td></tr>
...
<p style="margin:6px 0 0"><b>기저효과</b> 위 규칙 해당 · <b>PER괴리</b> 직접 계산 fPER과 네이버 PER(E)가 30% 이상 차이 — 비지배지분·EPS 기준 차이 가능성, 수기 확인 권장</p></div>
...
run(dict(
    ...
    source_note="타임폴리오 구성종목 + 네이버증권(모바일 API) 컨센서스 · fPOR=시총÷영업이익(E) · fPER=시총÷지배주주순이익(E) · 개인용",
